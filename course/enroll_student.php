...
<body>
    ...
    <div id="heading">
    	<h1 style="color: #FFF;">Enroll Students</h1>
    </div>
  <div id="container">
		<form action="enroll_student_script.php" method="get" style="padding-left:25px; padding-top:20px;width:200px;float:middle;">
		...
		<p style="margin-left:40px">Enter Student Roll No.:</p>
		<input type="text" name="sroll" style="border-radius:5px; width:200px;height:30px;margin-top:-10px">

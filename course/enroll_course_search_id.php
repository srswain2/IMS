...
<body>
  ...
  <div id="container">
		<form action="enroll_course_search_id_result.php" method="get" style="padding-left:65px; padding-top:20px">
		Enter Course-ID:<br>
		<input type="text" name="courseid" style="border-radius:5px; width:120px;height:30px"><br><br>
		<br><br>

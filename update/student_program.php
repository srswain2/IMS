...
<?php
    ...
    echo "<div id='heading'>
				<h1 style='color: #FFF;'>Update Program</h1>
			</div>
	<div id='container'>
		<form action='student_program.php' method='GET' style='padding-left:65px; padding-top:5px' enctype='multipart/form-data'>
		<p style='width:200px; margin-left:-15px;'>Enter Your Programme:</p><br>
		<input type='text' name='program' style='border-radius:5px; width:200px;height:30px; margin-top:-30px; margin-left:-40px'><br><br>
		<br><br>
	...
	if(isset($_GET['submit']))
	{
		...
		mysql_query("UPDATE student_info SET `program`='$program' WHERE roll='$roll'");

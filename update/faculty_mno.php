...
<?php
	...
	<div id='container'>
		<form action='faculty_mno.php' method='GET' style='padding-left:65px; padding-top:5px' enctype='multipart/form-data'>
	...
	if(isset($_GET['submit']))
	{
		...
		{
			mysql_query("UPDATE faculty_detail SET `mno`='$mno' WHERE roll='$roll'");

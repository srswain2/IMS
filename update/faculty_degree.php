...
<?php
	...
	<div id='container'>
		<form action='faculty_degree.php' method='GET' style='padding-left:65px; padding-top:5px' enctype='multipart/form-data'>
		<p style='width:150px; margin-left:8px;'>Enter Degrees (Separated by ','):</p><br>
		<input type='text' name='degree' style='border-radius:5px; width:200px;height:30px; margin-top:-30px; margin-left:-40px;'><br><br>
		<br><br>
	...
	if(isset($_GET['submit']))
	{
		...
		mysql_query("UPDATE faculty_detail SET `degree`='$degree' WHERE roll='$roll'");

...
<?php
	...
	<div id='container'>
		<form action='student_dob.php' method='GET' style='padding-left:65px; padding-top:5px' enctype='multipart/form-data'>
	...
	if(isset($_GET['submit']))
	{
		...
		mysql_query("UPDATE student_info SET `dob`='$dob' WHERE roll='$roll'");
